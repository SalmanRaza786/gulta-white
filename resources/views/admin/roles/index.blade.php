                ...
                columnDefs: [
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row, meta) {
                            ...
                            var btnPerm = '<a  href="'+url.replace(':role_id', data.id)+'" ><i class="ri-user-settings-line fs-4"></i></a>';
                            var btnEdit = ' <a href="#" class="btn-edit" data="'+rowId+'" data-bs-toggle="modal" data-bs-target="#showModal"><i class="ri-pencil-fill text-primary fs-4"></i></a>';
                            var btnDelete = '<a href="" class="btn-delete"  data="'+rowId+'"  data-bs-toggle="modal" data-bs-target="#deleteRecordModal"><i class="ri-delete-bin-fill text-danger fs-4"></i></a>';
                            return  btnPerm+  ' '+  btnEdit;
                        }
                    }
                ]
            });
