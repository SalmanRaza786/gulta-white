...
<div class="modal fade" id="giftModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header bg-light p-3">
                <h5 class="modal-title add-lang-title" id="exampleModalLabel" >{{__('translation.add')}} GIFT
                <h5 class="modal-title edit-lang-title" id="exampleModalLabel" style="display: none">{{__('translation.edit')}} @lang('translation.roles')</h5>
                <h5 class="modal-title" id="exampleModalLabel"></h5>
                <button type="button" class="btn-close btn-modal-close" data-bs-dismiss="modal" aria-label="Close" id="close-modal"></button>
            </div>
            ...
            <form method="post" class=" g-3 needs-validation" action="{{route('admin.product.code.gift')}}" autocomplete="off" id="GiftForm" enctype="multipart/form-data">
                @csrf
                <div class="modal-body">
                    <input type="number" name="gift_id" value="0" class="d-none">

                    <div class="mb-3">

                        <label for="validationCustom01" class="form-label">GIFT</label>
                        <input type="text" class="form-control" name="gift" placeholder="GIFT"  required>
